import { has, isArray, isEmpty, isNumber, isPlainObject, isString, reduce, tail } from 'lodash';
...
export { set, splice, push, pop, shift, unshift, sort, reverse, immutableDelete };
