...
var set = function set(path, value, setFunction) {
  return function (target) {
    return immutableSet(target, path, value, setFunction);
  };
};
var splice = function splice(start, deleteCount) {
...
var pop = curryRight(immutablePop);
var shift = curryRight(immutableShift);
...
var sort = curryRight(immutableSort);
var reverse = curryRight(immutableReverse);
var immutableDelete = curryRight(immutableDelete$1);
var filter$1 = curryRight(immutableFilter);
...
export { set, splice, push, pop, shift, unshift, sort, reverse, immutableDelete, filter$1 as filter, placeholder };
